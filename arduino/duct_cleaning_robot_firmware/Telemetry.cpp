...
static int printedL = 0, printedR = 0, printedA = 0, printedB = 0, printedLight = 0;
...
void telemetryReport() {
    ...
    printedL = applied.left;   printedR = applied.right;
    printedA = applied.act;    printedB = applied.brush;
    ...
    Serial.print(F(" BRUSH=")); Serial.print(applied.brush);
